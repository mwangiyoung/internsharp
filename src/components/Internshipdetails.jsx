...
const InternshipDetails = ({ company }) => {
  return (
    <div className="bg-gray-200 w-[22em] mx-auto rounded-3xl mt-4 mb-4 h-[80vh] p-4">
      ...
      <div className="bg-white rounded-xl p-4 shadow-md mb-4">
        <div className="flex items-center mb-4">
          <img src={company.icon} alt={company.name} className="rounded-full w-12 h-12 mr-4" />
          <div>
            <h2 className="text-lg text-green-600 font-bold">{company.name}</h2>

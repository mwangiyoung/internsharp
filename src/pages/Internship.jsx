...
const InternshipPage = () => {
  ...
  return (
    <div className="flex gap-[10em] items-center">
      <div className="flex gap-[5em]">
        ...
        <div className="bg-gray-200 h-[70vh] rounded-3xl">
          <div className="mt-6 bg-white p-4 rounded-lg shadow-md">
            <h2 className="text-lg text-sky-800 underline font-bold mb-4">
              Post an Internship
            </h2>
            <form onSubmit={handleFormSubmit}>
              <div className="mb-4">
                ...
                <input
                  ...
                  value={newInternship.internshiptitle}
              ...
              <div className="mb-4">
                <label className="block text-gray-700 mb-2">Applications</label>
                <input
                  type="text"
                  name="applications"
                  value={newInternship.applications}
                  onChange={handleInputChange}
                  className="w-full p-2 border rounded"
                  required
                />
      ...
      {/* Display internship details when company is clicked */}
      <div>
        {selectedCompany && (
          <InternshipDetails selectedCompany={selectedCompany} />
        )}
      </div>
    </div>
  );
